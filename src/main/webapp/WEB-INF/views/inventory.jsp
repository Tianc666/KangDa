...
<div><%--style="margin-left:200px;"--%>
	...
	<div class="page-container">
		<div class="text-c"> 日期范围：
			...
			<input type="text" name="" id="" placeholder=" 药品名称" style="width:250px" class="input-text">
			<button name="" id="" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜药品</button>
		</div>
...
<%--						<th width="100">药品是否过期</th>--%>
				...
				<tr class="text-c">
					<td>${inventory.mMedicineid}</td>
					<td>${inventory.mName}</td>
					<td>${inventory.mInventory}</td>
					<td>${inventory.mPrice}</td>
					<td>${inventory.mClassify}</td>
<%--					<td>郭德纲</td>--%>
				</tr>
