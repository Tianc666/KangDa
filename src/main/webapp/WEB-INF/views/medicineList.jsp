...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 康达药房 <span class="c-gray en">&gt;</span> 药品查看 <span class="c-gray en">&gt;</span> 药品信息 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
