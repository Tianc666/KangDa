...
<div class="page-container">
    <div class="text-c">
        <form class="Huiform" method="post" action="" target="_self">
            <input type="text" placeholder="销售表格" value="" class="input-text" style="width:120px">
  ...
  <option id="select" value="${Saleuname.user.uUsername}">${Saleuname.user.uUsername}</option>
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-sort">
            ...
            <tbody>
            <c:forEach items="${salesmessages2}" var="sale">
            <tr class="text-c">
...
<script type="text/javascript">
    ...
    function haha(){
        ...
        $.ajax({
            method: 'post',
            dataType: 'json',
            url:"${pageContext.request.contextPath}/salemessage?cuname="+cuname,
            // success:window.location.href="/salemessage?cuname="+cuname
        });
    }
